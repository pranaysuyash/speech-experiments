...
def main():
    ...
    parser.add_argument(
        "--name", required=True, help="Meeting name (no spaces, use dashes/underscores)"
    )
    parser.add_argument(
        "--pre", action="store_true", help="Enable preprocessing (normalization + silence removal)"
    )
    ...
    parser.add_argument(
        "--console-port", default="5174", help="Frontend console port (default: 5174)"
    )
