...
from harness.runner_schema import InputsSchema, QualityMetrics, RunnerArtifact, create_run_context
...
def run_diarization(
    ...
    output_dir: Path,
    device: str = "cpu",
    pre_ops: str | None = None,
    dataset_def: dict[str, Any] | None = None,
    force: bool = False,
) -> Path:
    """
