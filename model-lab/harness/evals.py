...
class EvaluationSuite:
    ...
    def evaluate(self, prediction: Any, reference: Any, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, EvaluationResult]:
    ...
    def plot_distribution(self, metric_name: str, save_path: Optional[str] = None):
...
class ModelComparator:
    ...
    def compare_models(self, model_results: Dict[str, List[float]], 
                      metric_name: str, confidence_level: float = 0.95) -> Dict[str, Any]:
        """
    ...
    def plot_comparison(self, model_results: Dict[str, List[float]], 
                       metric_name: str, save_path: Optional[str] = None):
