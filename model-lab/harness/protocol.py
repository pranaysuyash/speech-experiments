...
class RunContract:
    ...
    @staticmethod
    def calculate_dataset_hash(audio_path: Path, text_path: Path | None = None) -> str:
    ...
    def create_run_manifest(
        provider_id: str, config_path: Path, audio_path: Path, text_path: Path | None = None
    ) -> dict[str, Any]:
...
class NormalizationValidator:
    ...
    @staticmethod
    def normalize_text(text: str, protocol: dict | None = None) -> str:
        """
    ...
    @staticmethod
    def validate_normalization_parity(
        reference: str, hypothesis: str, provider1: str, provider2: str
    ) -> dict[str, Any]:
        """
