...
class LFMModelManager:
    ...
    def load_model(self, precision: str = "float32") -> Dict[str, Any]:
        ...
        if not LIQUID_AUDIO_AVAILABLE:
            raise RuntimeError("Liquid Audio library not available. Install with: pip install liquid-audio")
...
class AdvancedAudioProcessor:
    ...
    def process_audio(self, audio_path: str, normalize: bool = True) -> Tuple[torch.Tensor, int, Dict[str, Any]]:
...
def create_lfm_model_manager(repo_id: str = "LiquidAI/LFM2.5-Audio-1.5B", device: str = None) -> LFMModelManager:
