...
from harness.operability import evaluate_operability, filter_viable_evidence, get_task_thresholds
...
class TestEvaluateOperability:
    ...
    def test_rtf_like_max_enforced_pass(self):
        ...
        passed, failures = evaluate_operability(
            task="v2v", metrics={"rtf_like": 0.56}, thresholds={"rtf_like_max": 1.2}
        )
    ...
    def test_rtf_like_max_enforced_fail(self):
        ...
        passed, failures = evaluate_operability(
            task="v2v", metrics={"rtf_like": 1.5}, thresholds={"rtf_like_max": 1.2}
        )
    ...
    def test_speech_ratio_min_enforced(self):
        ...
        passed, failures = evaluate_operability(
            task="vad", metrics={"speech_ratio": 0.01}, thresholds={"speech_ratio_min": 0.05}
        )
    ...
    def test_speech_ratio_max_enforced(self):
        ...
        passed, failures = evaluate_operability(
            task="vad", metrics={"speech_ratio": 0.99}, thresholds={"speech_ratio_max": 0.95}
        )
    ...
    def test_empty_thresholds_always_pass(self):
        ...
        passed, failures = evaluate_operability(task="any", metrics={}, thresholds={})
    ...
    def test_none_thresholds_always_pass(self):
        ...
        passed, failures = evaluate_operability(task="any", metrics={}, thresholds=None)
...
class TestGetTaskThresholds:
    ...
    def test_gets_task_thresholds(self):
        ...
        config = {"vad": {"speech_ratio_min": 0.05}, "v2v": {"rtf_like_max": 1.2}}
...
class TestOperabilityNotAppliedToGolden:
    ...
    def test_golden_batch_bypasses_operability(self):
        ...
        evidence = [
            MockEvidence(
                "model1", EvidenceGrade.GOLDEN_BATCH, {"rtf_like": 99.0}
...
class TestOperabilityIntegration:
    ...
    def test_decisions_with_tiny_threshold_produces_rejection(self):
        ...
        test_use_case = {
            ...
            "requirements": {"primary": [{"task": "v2v", "min_grade": "smoke"}], "secondary": []},
            "operability": {
