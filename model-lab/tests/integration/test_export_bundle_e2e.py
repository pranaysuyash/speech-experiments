...
class TestExportBundleE2E:
    ...
    def test_export_bundle_happy_path(self, workspace):
        ...
        input_data = (
            "mock_video_data_12345"  # > 2MB if we wanted real file logic, but hash works on content
        )
        ...
        # ASR
        asr_data = {"inputs": {"audio_hash": real_input_hash}, "output": {"text": "Hello world"}}
        ...
        # Diarization
        diar_data = {"inputs": {"audio_hash": real_input_hash}, "output": {"segments": []}}
