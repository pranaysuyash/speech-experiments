...
class TestChaptersE2E:
    ...
    def test_chapters_flow(self, workspace):
        ...
        align_data = {
            ...
            "metrics": {
                "total_duration_s": 10.0, "coverage_ratio": 1.0, 
                "unknown_ratio": 0.0, "speaker_switch_count": 1, 
                "speaker_distribution": {}, "assigned_duration_s": 10.0
            },
        ...
        cmd = [
            ...
            "--from-artifact", str(align_file),
            "--embedding-cache-dir", str(workspace / "cache")
        ]
        ...
        with zipfile.ZipFile(workspace / "bundle.zip") as zf:
            ...
            if expected_name not in names:
                pytest.fail(f"Chapters artifact {expected_name} not found in zip.\nFiles: {names}\nSTDOUT:\n{res_exp.stdout}\nSTDERR:\n{res_exp.stderr}")
