# Prompt Quality Gate (prompt-quality-gate-v1.0)
...
- README indexing: `prompts/README.md` includes the prompt file name and short description.

Use the gate before adding new prompts to the repo.
