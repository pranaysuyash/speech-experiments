...
def main():
    ...
    print("\nNext steps:")
    print("  1. Update test notebooks to include conversation tests")
    print("  2. Add conversation-specific evaluation metrics")
    print("  3. Test models on multi-speaker audio")
