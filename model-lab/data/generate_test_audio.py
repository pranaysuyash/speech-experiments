...
def generate_test_audio_files(output_dir: Path):
    ...
    test_files = [
        ...
        },
        {
            ...
            "generator": lambda: (
                generate_sine_wave(261.63, 2.0, sample_rate) * 0.4  # C4
                + generate_sine_wave(329.63, 2.0, sample_rate) * 0.3  # E4
                + generate_sine_wave(392.00, 2.0, sample_rate) * 0.3
            ),  # G4
...
def main():
    ...
    parser.add_argument(
        "--output-dir", type=str, default="../data/audio", help="Output directory for audio files"
    )
    parser.add_argument(
        "--list-only",
        action="store_true",
