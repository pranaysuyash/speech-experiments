...
**Coverage:** Deep-read: README.md, QUICKSTART.md, server/main.py, client/package.json, pyproject.toml, key docs (20%). Skimmed: API files, harness modules, test results (50%). Skipped: node_modules, **pycache**, large data files (30%).
